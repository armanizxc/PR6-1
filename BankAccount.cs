...
namespace BankAccountNS
{
    ...
    public class BankAccount
    {
        ...
        public static void Main()
        {
            ...
            BankAccount dm = new BankAccount("Mr. Zakhar", 100.00);

            dm.Credit(50.55);
            dm.Debit(76.55);
            Console.WriteLine("Current balance (Mr. Zakhar) is ${0}", dm.Balance);
            Console.ReadLine();

            BankAccount oa = new BankAccount("Mr. Baby Melo", 25.55);

            oa.Credit(5.55);
            oa.Debit(15.00);
            Console.WriteLine("Current balance (Mr. Baby Melo) is ${0}", oa.Balance);
            Console.ReadLine();
        }
    }
}
